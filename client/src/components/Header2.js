    ...
    <ReactBootStrap.Navbar id="header" collapseOnSelect expand="lg" variant="dark">
      ...
      <ReactBootStrap.Navbar.Collapse id="responsive-navbar-nav">
        <ReactBootStrap.Nav className="ml-auto">
          ...
          <ReactBootStrap.Nav.Link>
            <NavLink exact={true} className="header-link" activeClassName="header-link-active" to={"/login"}>Articles</NavLink>
          </ReactBootStrap.Nav.Link>
          <ReactBootStrap.Nav.Link>
            <NavLink exact={true} className="header-link" activeClassName="header-link-active" to={"/signup"}>Sources</NavLink>
          </ReactBootStrap.Nav.Link>
        </ReactBootStrap.Nav>
      <ReactBootStrap.Nav className="ml-auto">
