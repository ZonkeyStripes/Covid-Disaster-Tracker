...
export default {
    getDisasters: function() {
        return Axios.get("https://www.fema.gov/api/open/v1/DisasterDeclarationsSummaries?$filter=declarationDate%20gt%20%272019-04-21T04:00:00.000z%27and incidentType ne 'Biological'")
    },
